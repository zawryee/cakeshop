<body class="bg-img" style="background-image: url('img/bg.png'); height: 100vh; object-fit: contain;"></body>
    ...
    <div class="ml-4 mr-3 d-flex justify-content-center">
      <h2 class="p-2 trans" style="border-radius: 1rem; text-shadow: 5px 5px #000000; color: #ff48a4; font-size: 70px; font-family: fantasy;">Bee Cake Shop</h2>
    </div>
  ...
  <div class="card mb-3 trans">
    <div class="card-body ">
      <form method="post" action="index.php?action=add&id=<?php echo $row["product_code"]; ?>">    
         <center><img src="img/cakes<?php echo $row["product_code"]; ?>.jpg" style="width: 100px">
